  ...
  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
    NavComponent,
    {
      ...
      className: `flex items-center px-3 py-[9px] rounded-md transition-all duration-200 group relative
                    ${isActive ? "bg-gray-800/80 text-gray-100" : "hover:bg-gray-800/50 text-gray-400 hover:text-gray-300"}`,
      onClick: () => {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center w-full", children: [
          /* @__PURE__ */ jsx("div", { className: `flex items-center justify-center h-5 w-5 transition-all duration-200 ${isActive ? "text-blue-400" : "text-gray-500 group-hover:text-gray-400"}`, children: /* @__PURE__ */ jsx(
            FontAwesomeIcon,
            {
              icon,
              className: `h-[14px] w-[14px] transition-transform duration-200 ${isActive ? "scale-105" : "group-hover:scale-105"}`
            }
          ) }),
          /* @__PURE__ */ jsx("span", { className: "ml-3 font-medium text-[13px] transition-colors duration-200", children: item.name })
        ] }),
        ...
        isActive && /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-3 bg-blue-500/80 rounded-r" })
      ]
    }
  ) }, item.id || item.href);
};
